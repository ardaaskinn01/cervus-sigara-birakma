...
class _OnboardingViewState extends ConsumerState<OnboardingView> {
  ...
  void _nextPage() {
    ...
    if (_currentIndex == 2 && _nameController.text.trim().isEmpty) return;
    if (_currentIndex == 3 && _ageController.text.trim().isEmpty) return;
    if (_currentIndex == 4 && _yearsController.text.trim().isEmpty) return;
    if (_currentIndex == 5 && _dailyController.text.trim().isEmpty) return;
    if (_currentIndex == 6 && _priceController.text.trim().isEmpty) return;
  ...
  Future<void> _saveData() async {
    ...
    try {
      ...
      // FCM Token kaydı (Kayıt sonrası ID oluştuğu için şimdi yapabiliriz)
                  ...
                  children: [
                    if (_currentIndex > 0)
                      TextButton(
                        ...
                        child: Text('onboarding.back_btn'.tr(), style: TextStyle(fontSize: 18, color: Colors.grey.shade500, fontWeight: FontWeight.w600)),
                      )
                    else
                    ...
                    AnimatedContainer(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isLoading 
                          ...
                          : Text(
                            _currentIndex == 7 ? 'onboarding.start_btn'.tr() :
            ...
            child: Center(
              child: Container(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    const Icon(Icons.language_rounded, size: 48, color: Color(0xFF4CAF50)),
                    const SizedBox(height: 32),
                    Text(
                      'profile.language'.tr(),
                      style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: Color(0xFF1B5E20), letterSpacing: -0.5),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: context.locale.languageCode == 'tr' ? const Color(0xFFE8F5E9) : Colors.white,
                          side: BorderSide(color: context.locale.languageCode == 'tr' ? const Color(0xFF4CAF50) : Colors.grey.shade300, width: 2),
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                          elevation: 0,
                        ),
                        child: const Text('Türkçe', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1B5E20))),
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          padding: const EdgeInsets.symmetric(vertical: 16),
                          backgroundColor: context.locale.languageCode == 'en' ? const Color(0xFFE8F5E9) : Colors.white,
                          side: BorderSide(color: context.locale.languageCode == 'en' ? const Color(0xFF4CAF50) : Colors.grey.shade300, width: 2),
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                          elevation: 0,
                        ),
                        child: const Text('English', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1B5E20))),
                      ),
                    ),
                  ],
                ),
